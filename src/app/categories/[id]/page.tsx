...
export default async function CategoryProducts({
  ...
  return (
    <div className="p-6">
      ...
      {data.length === 0 ? (
            <p className="text-red-600 text-3xl font-semibold text-center">No products found for this Category.</p>
      ) : (
      <>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {data.map((product: Product) => (
            ...
            >
              ...
              <p className=" text-center text-green-500">Price: {product.price} EGP</p>
            </div>
          ))}
        </div>
      </>
